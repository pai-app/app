...
/**
 * Virtualized transaction list with sticky month headers. Drives off the app's
 * global scroll container (`useApp().scrollElementRef`); the currently-pinned
 * month header stays mounted via a custom range extractor.
 */
